...
class EventoController extends Controller
{
    ...
    public function show($id)
    {
        ...
        // Três passos para resolver, o primeiro é colocar Pergunta::where('evento_id', $evento->id), o segundo é colocar o latest() ele ordena e o terceiro depois de latest coloque paginate()
        $perguntas = Pergunta::where('evento_id', $evento->id)->with('user')->latest()->paginate(10);
